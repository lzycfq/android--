...
//		
//		  web = new WebView(MipcaActivityCapture.this);
//			web.loadUrl("http://10.3.173.147:8080/Za/addjilu?kid=006&sid=4&time=2016-12-29 20:05:00&shangxia=1&zhuangtai=2");
//			setContentView(web);
//			Toast.makeText(getApplicationContext(), "ǩ���ɹ�", 0).show();
